        ...
        <View className="flex-1 bg-black">
          ...
          >
            <View className="flex-1 mt-[120px]">
              ...
              <View className="p-4 mt-[145px] flex-1">
                ...
                <View className="bottom-[6%] pt-4">
                  <TouchableOpacity
                    className="bg-[#ff7a7f] rounded-xl h-[50px] w-[250px] items-center justify-center flex-row self-center"
